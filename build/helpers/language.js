...
exports.isJp = exports.isEven = exports.isNotNil = exports.removeDupeObjects = exports.removeDupes = exports.ciEquals = exports.toTitleCase = exports.doNothing = exports.asyncFind = exports.throwIt = exports.sleep = exports.match = void 0;
...
async function asyncFind(haystack, predicate) {
    ...
    return (0, ramda_1.isEmpty)(haystack)
        ? undefined
        : (await checkHead())
            ? (0, ramda_1.head)(haystack)
