...
exports.guildSettingsEnmap = new enmap_1.default({
    name: 'guildSettings',
});
/**
...
function updateSettings(x, update) {
    const isObject = x instanceof discord_js_1.CommandInteraction || x instanceof discord_js_1.Guild || x instanceof discord_js_1.GuildMember;
