...
exports.clearOldBotData = exports.addToBotRelayHistory = exports.getRelayHistory = exports.getBotData = exports.getNotifiedCommunityPosts = exports.addNotifiedCommunityPost = exports.getNotifiedLives = exports.addNotifiedLive = exports.botDataEnmap = void 0;
...
async function clearOldBotData() {
    const history = (await getBotData()).relayHistory;
    console.log(`history len is ${history.size}`);
    const newHistory = (0, immutableES6MapFunctions_1.filter)(history, (v, k) => v[0].absoluteTime > Date.now() - 86400000);
    console.log(`new his len ${newHistory.size}`);
    updateBotData({ relayHistory: newHistory });
}
exports.clearOldBotData = clearOldBotData;
///////////////////////////////////////////////////////////////////////////////
